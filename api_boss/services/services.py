...
class ClassService:
    ...
    def add_class(self, new_class):
        try:
            ...
            max_class = self.db_conn.db.bosses.find_one(sort=[('_id', -1)])
            ...
            self.db_conn.db.bosses.insert_one(new_class)
    ...
    def get_class_by_id(self, class_id):
        try:
            ...
            class_data = self.db_conn.db.bosses.find_one({'_id': class_id})
    ...
    def update_class(self, class_id, class_data):
        try:
            ...
            if update_class:
                ...
                updated_class = self.db_conn.db.bosses.update_one({'_id': class_id}, {'$set': class_data})
    ...
    def delete_class(self, class_id):
        try:
            ...
            if deleted_class:
                ...
                self.db_conn.db.bosses.delete_one({'_id': class_id})
...
if __name__ == '__main__':
    ...
    try:
        ...
        bosses = class_service.get_all_bosses()
